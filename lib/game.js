...
// Retrieve dimensions
  ...
  createRoomMatrix () {
    ...
    this.roomMatrix[9][0] = StartingRoom;
    this.roomMatrix[8][0] = FirstRoom;
    this.roomMatrix[7][0] = SecondRoom;
    this.roomMatrix[7][1] = ThirdRoom;
    this.roomMatrix[7][2] = FourthRoom;
    this.roomMatrix[6][2] = FifthRoom;
    this.roomMatrix[5][2] = SixthRoom;
  }
