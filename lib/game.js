...
// Retrieve dimensions
  ...
  renderObjects () {
    // let compositeArray = this.masterContainer.children.slice(1, this.masterContainer.children.length - 3);
    ...
    // compositeArray = allObjects.reduce( ([], array)=> { [].concat(array)} );

    compositeArray.sort(this.sortingFunction)

    // console.log(allObjects[0].children);
    ...
    // this.masterContainer.addChild(this.sights);
    this.masterContainer.addChild(this.fader);
