...
class PlayerCharacter extends PIXI.Container {
  ...
  move (timeDelta) {
    ...
    //     this.velY  = -(this.baseSpeed * (1 / Math.sqrt(2)))
    //   } else {
    ...
    //     this.velX = -(this.baseSpeed * (1 / Math.sqrt(2)))
    //   } else {
  ...
  animate (timeDelta) {
    ...
    if (this.attack) {
      this.animateAttack(stopped, timeDelta);
    } else {
      this.animateMovement(stopped, timeDelta);
    }
    this.stopped = stopped;
  }

  animateMovement (stopped, timeDelta) {
