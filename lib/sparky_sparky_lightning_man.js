...
class SparkySparkyLightningMan extends PIXI.Container {
  constructor(position, velocity, game) {
    ...
    // this.behaviors = {
    //   "move": (object) => { MovingObject.move(object); },
    //   "enforceBoundaries": (object) => { MovingObject.enforceBoundaries(object); }
    // };
  }
  ...
  createLightning(target) {
    ...
    this.addChild(this.attackBorders);
  }
  ...
  attack(target) {
    this.sprite.texture = this.attackTexture;
    this.attacking = true;
    this.attackDelay = 0;
