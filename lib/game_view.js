...
class GameView {
  ...
  start () {
    ...
    let textures = [
      ...
      'assets/sprites/walls/placeholder_wall.png',
      ...
      'assets/backgrounds/cliffside_bottom_room_background.png',
      'assets/backgrounds/cliffside_top_room_background.png',
      'assets/sprites/items/basic_health_pack.png',
      'assets/sprites/items/special_pack.png',
      'assets/sprites/weapons/murk.png',
      ...
      'assets/sprites/roland/movement/up_right0.png',
      'assets/sprites/roland/movement/up_right1.png',
      'assets/sprites/roland/movement/up0.png',
      'assets/sprites/roland/movement/up1.png',
      'assets/sprites/roland/movement/up_left0.png',
      'assets/sprites/roland/movement/up_left1.png',
      ...
      'assets/sprites/roland/primary_attack/up_right0.png',
      'assets/sprites/roland/primary_attack/up_right1.png',
      'assets/sprites/roland/primary_attack/up0.png',
      'assets/sprites/roland/primary_attack/up1.png',
      'assets/sprites/roland/primary_attack/up_left0.png',
      'assets/sprites/roland/primary_attack/up_left1.png',
      ...
      'assets/sprites/orville/movement/down0.png',
      'assets/sprites/orville/movement/down1.png',
      'assets/sprites/orville/movement/down_right0.png',
      'assets/sprites/orville/movement/down_right1.png',
      'assets/sprites/orville/movement/right0.png',
      'assets/sprites/orville/movement/right1.png',
      'assets/sprites/orville/movement/up_right0.png',
      'assets/sprites/orville/movement/up_right1.png',
      'assets/sprites/orville/movement/up0.png',
      'assets/sprites/orville/movement/up1.png',
      'assets/sprites/orville/movement/up_left0.png',
      'assets/sprites/orville/movement/up_left1.png',
      'assets/sprites/orville/movement/left0.png',
      'assets/sprites/orville/movement/left1.png',
      'assets/sprites/orville/movement/down_left0.png',
      'assets/sprites/orville/movement/down_left1.png',
    ...
    let textureNames = [
      ...
      'cliffside_bottom_room_background',
      'cliffside_top_room_background',
      'health_pack',
      'special_pack',
      'murk',
      'roland_down0',
