  ...
  move () {
    ...
    if (this.aware) {
      if (this.attacking) {
        ...
        this.chase(this.game.players.children[0]);
  ...
  animateAttack () {
    ...
    switch (this.dagger.animationCounter) {
      ...
      case 10:
        ...
        if (SAT.testPolygonPolygon(this.hitBox, this.game.players.children[0].hitBox)) {
          this.game.players.children[0].healthLost += 50;
        }
        break;
